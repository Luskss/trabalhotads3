...
<html lang="pt-br">
    ...
    <div id="layoutAuthentication_content">
        <main>
            ...
            <div class="card-body">
            <form action="actionregempresa.php?pagina=formregistroempresa" method="POST" class="was-validated" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div><h4 class=" text-center font-weight-light my-4">Informações da sua Empresa</h4></div>
                            <div class="form-floating mb-3">
                                <input type="text" maxlength="18"class="form-control" id="cnpj" placeholder="00.000.000/0000-00" name="cnpj" required>
                                <label for="cnpj"> Cnpj da Empresa</label>
                                <div class="valid-feedback"></div>
                                <div class="invalid-feedback">Use o formato 00.000.000/0000-00.</div>
                            </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="razaosocial" placeholder="Razão Social" name="razaosocial" required>
                            <label for="razaosocial">Razão Social</label>
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="form-floating mb-3 mb-md-0">
                            <input type="number" class="form-control" id="numerofuncionarios" min="1" placeholder="Numero de Funcionários" name="numerofuncionarios" required>
                            <label for="numerofuncionarios">Numero de Funcionários</label>
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback"></div>
                        </div>
                        <div>
